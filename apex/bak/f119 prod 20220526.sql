...
--   Date and Time:   09:38 Thursday May 26, 2022
--   Exported By:     EDFI
--   Flashback:       0
...
,p_flow_unavailable_text=>'This application is currently unavailable at this time for new and exciting updates.  Please check back later.'
...
,p_substitution_value_01=>'EDFI Monitoring'
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20220526092829'
...
',V_DISTRICTS.EDFI_VERSION',
'INTO :G_USER_SID,:G_DISTRICT_CDN,:G_ODS_NUMBER,:G_SUPER_USER,:G_EDFI_VERSION',
'FROM USER_ACCOUNT_V',
'LEFT JOIN V_DISTRICTS ON V_DISTRICTS.DISTRICT_CDC = USER_ACCOUNT_V.DISTRICT_CDN',
...
,p_browser_cache=>'N'
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20210120092959'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(23599646403980635)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23599713134980636)
,p_name=>'P1_DATA_AS_OF_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(23599646403980635)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(23599898212980637)
...
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20210426113041'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(23600748563980646)
...
wwv_flow_api.create_ig_report_column(
 p_id=>wwv_flow_api.id(52514581870682212)
,p_view_id=>wwv_flow_api.id(19214435841899928)
,p_display_seq=>23
,p_column_id=>wwv_flow_api.id(23600748563980646)
,p_is_visible=>true
,p_is_frozen=>false
);
wwv_flow_api.create_page_plug(
...
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20210908141851'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(23600910188980648)
,p_name=>'Close Dialog'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23601069990980649)
,p_event_id=>wwv_flow_api.id(23600910188980648)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20210316155518'
);
wwv_flow_api.create_page_plug(
...
,p_last_upd_yyyymmddhh24miss=>'20210201155042'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23599933890980638)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23600000536980639)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23600101217980640)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23600261931980641)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(23600367155980642)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(48250126035627908)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(23600690264980645)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23600512235980644)
,p_process_sequence=>10
,p_process_point=>'BEFORE_BOX_BODY'
,p_process_type=>'NATIVE_PLSQL'
...
,p_last_updated_by=>'EDFI'
,p_last_upd_yyyymmddhh24miss=>'20210120092829'
);
wwv_flow_api.create_page_plug(
